...
#
# https://github.com/dxx-rebirth/dxx-rebirth/blob/master/contrib/gentoo/games-action/dxx-rebirth/dxx-rebirth-9999.ebuild
#
...
SLOT="0"
# Other architectures are reported to work, but not tested regularly by the core team.
#
...
KEYWORDS="~amd64 ~x86"
# Default to building both game engines. The total size is relatively small.
